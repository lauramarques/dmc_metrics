...
This document loads and visualizes data on the usage of modules from the Data Management Campus.  
The data are obtained from four sources: the OpenLearnity platform, Matomo, Google Analytics, and Zenodo.  
...
Unique pageviews is the number of distint page views of the module’s “About” page ( counted once per session).  
...
Blue, green, and red bars represent different resource types: modules, intro videos, and case studies, respectively. Only 6 of the 10 modules include associated case studies (PowToon videos).   
